...
//!
//! `ICHIRAN/DICT:ABBR-N` reconstructs `root + "ない"` and runs
//! `find-word-with-conj-prop` on it, keeping only negative-conjugation
//! matches outside the 居ない/来ない blocklist. Captured args are
...
use kaniran_core::dict::grammar::suffix::abbr::abbr_n;
