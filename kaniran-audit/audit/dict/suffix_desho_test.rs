...
//! `suffix-desho` `def-simple-suffix` (`dict-grammar.lisp:532`) and
...
//! `Constant(300)` score-mod path is never actually compared.
...
use kaniran_core::dict::grammar::suffix::rules::suffix_desho;
