...
//!
//! `ICHIRAN/DICT:SUFFIX-CHAU` is a `def-simple-suffix`
//! (`dict-grammar.lisp:418`). The macro signature is `(root sv kf)`,
...
use kaniran_core::dict::grammar::suffix_rules::suffix_chau;
