...
//!
//! `ICHIRAN/DICT:SUFFIX-GARU` is a `def-simple-suffix`
//! (`dict-grammar.lisp:495`). The macro signature is `(root sv kf)`,
...
use kaniran_core::dict::grammar::suffix_rules::suffix_garu;
