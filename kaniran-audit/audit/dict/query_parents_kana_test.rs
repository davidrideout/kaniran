//! Manual fixture-replay runner for `ICHIRAN/DICT:QUERY-PARENTS-KANA`.
//! Source under test: `src/dict/query_parents_kana.rs`.
//!
//! Run with:
...
use kaniran_core::dict::readings::query_parents_kana;

use common::CapturedRow;

const EXPECTED_FQN: &str = "ICHIRAN/DICT:QUERY-PARENTS-KANA";
...
fn audit_one(
    ...
    let mut actual = query_parents_kana(ctx, seq, text)
        
        .map_err(|err| format!("query_parents_kana: {}", err))?;
