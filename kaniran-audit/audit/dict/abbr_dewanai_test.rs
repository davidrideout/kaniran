...
//!
//! `ICHIRAN/DICT:ABBR-DEWANAI` reconstructs `root + "ではない"` (destem
//! length 4) and runs `find-word-full` on it. Captured args are
...
use kaniran_core::dict::grammar::suffix::abbr::abbr_dewanai;
