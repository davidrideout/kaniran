...
//!
//! `ICHIRAN/DICT:SUFFIX-IADJ` is a `def-simple-suffix`
//! (`dict-grammar.lisp:492`). The macro signature is `(root sv kf)`,
...
use kaniran_core::dict::grammar::suffix_rules::suffix_iadj;
