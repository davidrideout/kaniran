...
//!
//! `ICHIRAN/DICT:SUFFIX-KURAI` is a `def-simple-suffix`
//! (`dict-grammar.lisp:540`). The macro signature is `(root sv kf)`,
...
use kaniran_core::dict::grammar::suffix_rules::suffix_kurai;
