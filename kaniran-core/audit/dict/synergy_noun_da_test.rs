//! Manual fixture-replay runner for `ICHIRAN/DICT:SYNERGY-NOUN-DA`.
//! Source under test: `src/dict/synergy_noun_da.rs`.
//!
//! Run with:
...
const EXPECTED_FQN: &str = "ICHIRAN/DICT:SYNERGY-NOUN-DA";
