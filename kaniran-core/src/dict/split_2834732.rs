//! Port of `ichiran/dict:split-2834732` (`dict-split.lisp:680`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2834732`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:680`).
//!
...
pub async fn split_2834732(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2834732i32) {
            None
