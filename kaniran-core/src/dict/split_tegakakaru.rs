//! Port of `ichiran/dict:split-tegakakaru` (`dict-split.lisp:234`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2089710`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:234`).
//!
...
pub async fn split_tegakakaru(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2089710i32) {
            None
