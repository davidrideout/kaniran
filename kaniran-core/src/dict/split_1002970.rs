//! Port of `ichiran/dict:split-1002970` (`dict-split.lisp:446`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1002970`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:446`).
//!
...
pub async fn split_1002970(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1002970i32) {
            None
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "知れない", &[1420490i32]).await?;
