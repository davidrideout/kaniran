//! Port of `ichiran/dict:split-gotoni` (`dict-split.lisp:352`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1524660`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:352`).
//!
...
pub async fn split_gotoni(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1524660i32) {
            None
