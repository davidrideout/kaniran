//! Port of `ichiran/dict:split-2272780` (`dict-split.lisp:559`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2272780`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:559`).
//!
...
pub async fn split_2272780(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2272780i32) {
            None
