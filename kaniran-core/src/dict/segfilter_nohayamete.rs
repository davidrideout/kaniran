...
mod tests {
    ...
    fn nh_a_l_nil_r_match() {
        ...
        let r = sl(0, 1, vec![seg(0, 1, info_with_seq_set(vec![1601080]))]);
    ...
    fn nh_c_l_not_no_r_hayamete() {
        ...
        let r = sl(1, 2, vec![seg(1, 2, info_with_seq_set(vec![1601080]))]);
    ...
    fn nh_d_l_is_no_r_hayamete_empty() {
        ...
        let l = sl(0, 1, vec![seg(0, 1, info_with_seq_set(vec![1469800]))]);
        let r = sl(1, 2, vec![seg(1, 2, info_with_seq_set(vec![1601080]))]);
        let result = segfilter_nohayamete(Some(&l), &r);
