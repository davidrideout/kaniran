//! Port of `ichiran/dict:split-de-1682060` (`dict-split.lisp:123`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1682060`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:123`).
//!
...
pub async fn split_de_1682060(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1682060i32) {
            None
