//! Port of `ichiran/dict:split-2007500` (`dict-split.lisp:623`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2007500`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:623`).
//!
...
pub async fn split_2007500(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "落ち", &[1548550i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2007500i32) {
            None
