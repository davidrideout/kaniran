//! Port of `ichiran/dict:split-janai` (`dict-split.lisp:407`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2755350`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:407`).
//!
...
pub async fn split_janai(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2755350i32) {
            None
