//! Port of `ichiran/dict:split-shi-1157310` (`dict-split.lisp:206`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1157310`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:206`).
//!
...
pub async fn split_shi_1157310(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1157310i32) {
            None
