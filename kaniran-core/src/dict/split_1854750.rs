//! Port of `ichiran/dict:split-1854750` (`dict-split.lisp:535`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1854750`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:535`).
//!
...
pub async fn split_1854750(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "付いて", &[1495740i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1854750i32) {
            None
