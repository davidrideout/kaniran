//! Port of `ichiran/dict:split-1005600` (`dict-split.lisp:451`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1005600`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:451`).
//!
...
pub async fn split_1005600(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "しまった", &[1305380i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1005600i32) {
            None
