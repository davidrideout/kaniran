//! Port of `ichiran/dict:split-shinikakaru` (`dict-split.lisp:318`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1881080`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:318`).
//!
...
pub async fn split_shinikakaru(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1881080i32) {
            None
