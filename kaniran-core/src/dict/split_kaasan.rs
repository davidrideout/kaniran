//! Port of `ichiran/dict:split-kaasan` (`dict-split.lisp:258`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1609470`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:258`).
//!
...
pub async fn split_kaasan(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1609470i32) {
            None
