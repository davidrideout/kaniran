//! Port of `ichiran/dict:split-2846470` (`dict-split.lisp:564`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2846470`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:564`).
//!
...
pub async fn split_2846470(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2846470i32) {
            None
