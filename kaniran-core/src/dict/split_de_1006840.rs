//! Port of `ichiran/dict:split-de-1006840` (`dict-split.lisp:106`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1006840`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:106`).
//!
...
pub async fn split_de_1006840(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1006840i32) {
            None
