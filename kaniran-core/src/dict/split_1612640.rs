//! Port of `ichiran/dict:split-1612640` (`dict-split.lisp:460`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1612640`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:460`).
//!
...
pub async fn split_1612640(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1612640i32) {
            None
    ...
    {
        let pseq: &[i32] = &[2029080i32, 2029120i32, 1005110i32];
