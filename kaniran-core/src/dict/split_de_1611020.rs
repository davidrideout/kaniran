//! Port of `ichiran/dict:split-de-1611020` (`dict-split.lisp:103`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1611020`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:103`).
//!
...
pub async fn split_de_1611020(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1611020i32) {
            None
