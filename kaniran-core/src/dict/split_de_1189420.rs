//! Port of `ichiran/dict:split-de-1189420` (`dict-split.lisp:110`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1189420`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:110`).
//!
...
pub async fn split_de_1189420(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1189420i32) {
            None
