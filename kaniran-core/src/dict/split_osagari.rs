//! Port of `ichiran/dict:split-osagari` (`dict-split.lisp:356`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1693800`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:356`).
//!
...
pub async fn split_osagari(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1693800i32) {
            None
