//! Port of `ichiran/dict:split-toori-1424960` (`dict-split.lisp:151`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1424960`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:151`).
//!
...
pub async fn split_toori_1424960(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1424960i32) {
            None
