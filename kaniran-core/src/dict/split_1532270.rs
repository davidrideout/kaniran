//! Port of `ichiran/dict:split-1532270` (`dict-split.lisp:627`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1532270`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:627`).
//!
...
pub async fn split_1532270(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "あけまして", &[1202450i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1532270i32) {
            None
