//! Port of `ichiran/dict:split-tonaru` (`dict-split.lisp:377`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2100900`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:377`).
//!
...
pub async fn split_tonaru(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2100900i32) {
            None
