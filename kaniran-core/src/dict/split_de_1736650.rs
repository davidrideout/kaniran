//! Port of `ichiran/dict:split-de-1736650` (`dict-split.lisp:124`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1736650`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:124`).
//!
...
pub async fn split_de_1736650(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1736650i32) {
            None
