//! Port of `ichiran/dict:split-shi-1157280` (`dict-split.lisp:205`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1157280`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:205`).
//!
...
pub async fn split_shi_1157280(
    ctx: &KaniranContext,
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "し", &[1157170i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1157280i32) {
            None
