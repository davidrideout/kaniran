//! Port of `ichiran/dict:split-shi-1157200` (`dict-split.lisp:202`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1157200`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:202`).
//!
...
pub async fn split_shi_1157200(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1157200i32) {
            None
