//! Port of `ichiran/dict:split-soudesu` (`dict-split.lisp:267`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2837492`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:267`).
//!
...
pub async fn split_soudesu(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2837492i32) {
            None
