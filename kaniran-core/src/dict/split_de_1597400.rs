//! Port of `ichiran/dict:split-de-1597400` (`dict-split.lisp:121`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1597400`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:121`).
//!
...
pub async fn split_de_1597400(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1597400i32) {
            None
