//! Port of `ichiran/dict:split-2009290` (`dict-split.lisp:438`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2009290`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:438`).
//!
...
pub async fn split_2009290(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2009290i32) {
            None
