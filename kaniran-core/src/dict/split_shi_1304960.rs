//! Port of `ichiran/dict:split-shi-1304960` (`dict-split.lisp:208`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1304960`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:208`).
//!
...
pub async fn split_shi_1304960(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1304960i32) {
            None
