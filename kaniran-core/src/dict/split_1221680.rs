//! Port of `ichiran/dict:split-1221680` (`dict-split.lisp:472`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1221680`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:472`).
//!
...
pub async fn split_1221680(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1221680i32) {
            None
