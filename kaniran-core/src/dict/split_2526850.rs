//! Port of `ichiran/dict:split-2526850` (`dict-split.lisp:538`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2526850`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:538`).
//!
...
pub async fn split_2526850(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2526850i32) {
            None
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "しろ", &[1157170i32]).await?;
