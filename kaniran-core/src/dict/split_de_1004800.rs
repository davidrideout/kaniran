//! Port of `ichiran/dict:split-de-1004800` (`dict-split.lisp:104`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1004800`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:104`).
//!
...
pub async fn split_de_1004800(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1004800i32) {
            None
