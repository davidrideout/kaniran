//! Port of `ichiran/dict:split-de-1531420` (`dict-split.lisp:120`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1531420`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:120`).
//!
...
pub async fn split_de_1531420(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1531420i32) {
            None
