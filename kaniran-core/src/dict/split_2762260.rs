//! Port of `ichiran/dict:split-2762260` (`dict-split.lisp:429`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2762260`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:429`).
//!
...
pub async fn split_2762260(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "ならんで", &[1508380i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2762260i32) {
            None
