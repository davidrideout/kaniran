//! Port of `ichiran/dict:split-1863230` (`dict-split.lisp:635`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1863230`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:635`).
//!
...
pub async fn split_1863230(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1863230i32) {
            None
