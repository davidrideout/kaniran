//! Port of `ichiran/dict:split-shi-1594580` (`dict-split.lisp:215`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1594580`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:215`).
//!
...
pub async fn split_shi_1594580(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1594580i32) {
            None
