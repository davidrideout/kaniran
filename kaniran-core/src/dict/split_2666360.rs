//! Port of `ichiran/dict:split-2666360` (`dict-split.lisp:404`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2666360`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:404`).
//!
...
pub async fn split_2666360(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "少なくない", &[1348910i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2666360i32) {
            None
