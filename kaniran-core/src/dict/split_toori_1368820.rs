//! Port of `ichiran/dict:split-toori-1368820` (`dict-split.lisp:161`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1368820`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:161`).
//!
...
pub async fn split_toori_1368820(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1368820i32) {
            None
