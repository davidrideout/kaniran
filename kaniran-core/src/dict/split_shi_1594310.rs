//! Port of `ichiran/dict:split-shi-1594310` (`dict-split.lisp:213`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1594310`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:213`).
//!
...
pub async fn split_shi_1594310(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1594310i32) {
            None
