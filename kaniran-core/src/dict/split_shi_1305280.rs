//! Port of `ichiran/dict:split-shi-1305280` (`dict-split.lisp:210`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1305280`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:210`).
//!
...
pub async fn split_shi_1305280(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1305280i32) {
            None
