//! Port of `ichiran/dict:split-shi-1157230` (`dict-split.lisp:204`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1157230`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:204`).
//!
...
pub async fn split_shi_1157230(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1157230i32) {
            None
