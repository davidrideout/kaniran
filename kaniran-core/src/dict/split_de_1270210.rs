//! Port of `ichiran/dict:split-de-1270210` (`dict-split.lisp:133`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1270210`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:133`).
//!
...
pub async fn split_de_1270210(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1270210i32) {
            None
