//! Port of `ichiran/dict:split-toori-1523010` (`dict-split.lisp:157`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1523010`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:157`).
//!
...
pub async fn split_toori_1523010(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1523010i32) {
            None
