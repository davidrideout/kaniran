//! Port of `ichiran/dict:split-de-1454270` (`dict-split.lisp:116`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1454270`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:116`).
//!
...
pub async fn split_de_1454270(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1454270i32) {
            None
