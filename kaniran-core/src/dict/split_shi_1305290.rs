//! Port of `ichiran/dict:split-shi-1305290` (`dict-split.lisp:211`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1305290`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:211`).
//!
...
pub async fn split_shi_1305290(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1305290i32) {
            None
