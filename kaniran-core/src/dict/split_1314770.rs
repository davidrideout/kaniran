//! Port of `ichiran/dict:split-1314770` (`dict-split.lisp:583`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1314770`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:583`).
//!
...
pub async fn split_1314770(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1314770i32) {
            None
