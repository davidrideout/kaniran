//! Port of `ichiran/dict:split-1221530` (`dict-split.lisp:554`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1221530`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:554`).
//!
...
pub async fn split_1221530(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1221530i32) {
            None
