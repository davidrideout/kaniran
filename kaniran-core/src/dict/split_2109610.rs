//! Port of `ichiran/dict:split-2109610` (`dict-split.lisp:654`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2109610`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:654`).
//!
...
pub async fn split_2109610(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "有り", &[1296400i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2109610i32) {
            None
