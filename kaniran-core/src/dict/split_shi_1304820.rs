//! Port of `ichiran/dict:split-shi-1304820` (`dict-split.lisp:218`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1304820`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:218`).
//!
...
pub async fn split_shi_1304820(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1304820i32) {
            None
