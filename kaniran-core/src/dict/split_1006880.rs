//! Port of `ichiran/dict:split-1006880` (`dict-split.lisp:667`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1006880`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:667`).
//!
...
pub async fn split_1006880(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1006880i32) {
            None
