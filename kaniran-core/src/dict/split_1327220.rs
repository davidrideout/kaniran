//! Port of `ichiran/dict:split-1327220` (`dict-split.lisp:381`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1327220`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:381`).
//!
...
pub async fn split_1327220(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1327220i32) {
            None
