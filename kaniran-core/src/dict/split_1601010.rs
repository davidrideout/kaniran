//! Port of `ichiran/dict:split-1601010` (`dict-split.lisp:671`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1601010`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:671`).
//!
...
pub async fn split_1601010(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "跳ね", &[1429620i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1601010i32) {
            None
