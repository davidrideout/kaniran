//! Port of `ichiran/dict:split-de-1878880` (`dict-split.lisp:126`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1878880`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:126`).
//!
...
pub async fn split_de_1878880(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1878880i32) {
            None
