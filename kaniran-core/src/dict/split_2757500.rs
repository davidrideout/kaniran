//! Port of `ichiran/dict:split-2757500` (`dict-split.lisp:482`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2757500`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:482`).
//!
...
pub async fn split_2757500(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2757500i32) {
            None
