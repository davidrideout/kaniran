//! Port of `ichiran/dict:split-toori-1414570` (`dict-split.lisp:148`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1414570`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:148`).
//!
...
pub async fn split_toori_1414570(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1414570i32) {
            None
