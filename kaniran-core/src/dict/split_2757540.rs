//! Port of `ichiran/dict:split-2757540` (`dict-split.lisp:615`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2757540`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:615`).
//!
...
pub async fn split_2757540(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2757540i32) {
            None
