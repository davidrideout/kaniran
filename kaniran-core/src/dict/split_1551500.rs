//! Port of `ichiran/dict:split-1551500` (`dict-split.lisp:575`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1551500`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:575`).
//!
...
pub async fn split_1551500(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "立ち", &[1597040i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1551500i32) {
            None
