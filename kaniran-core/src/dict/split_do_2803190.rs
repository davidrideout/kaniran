//! Port of `ichiran/dict:split-do-2803190` (`dict-split.lisp:179`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2803190`.
//! Generated upstream by `def-do-split` (`dict-split.lisp:179`).
//!
...
pub async fn split_do_2803190(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2803190i32) {
            None
