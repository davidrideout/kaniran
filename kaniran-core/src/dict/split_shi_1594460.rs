//! Port of `ichiran/dict:split-shi-1594460` (`dict-split.lisp:214`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1594460`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:214`).
//!
...
pub async fn split_shi_1594460(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1594460i32) {
            None
