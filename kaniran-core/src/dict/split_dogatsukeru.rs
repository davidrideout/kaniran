//! Port of `ichiran/dict:split-dogatsukeru` (`dict-split.lisp:249`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2800540`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:249`).
//!
...
pub async fn split_dogatsukeru(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2800540i32) {
            None
