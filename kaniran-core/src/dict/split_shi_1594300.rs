//! Port of `ichiran/dict:split-shi-1594300` (`dict-split.lisp:212`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1594300`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:212`).
//!
...
pub async fn split_shi_1594300(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1594300i32) {
            None
