//! Port of `ichiran/dict:split-toori-1462720` (`dict-split.lisp:169`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1462720`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:169`).
//!
...
pub async fn split_toori_1462720(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1462720i32) {
            None
