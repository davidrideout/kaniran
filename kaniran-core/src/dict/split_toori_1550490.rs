//! Port of `ichiran/dict:split-toori-1550490` (`dict-split.lisp:163`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1550490`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:163`).
//!
...
pub async fn split_toori_1550490(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1550490i32) {
            None
