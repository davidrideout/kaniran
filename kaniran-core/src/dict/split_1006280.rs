//! Port of `ichiran/dict:split-1006280` (`dict-split.lisp:611`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1006280`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:611`).
//!
...
pub async fn split_1006280(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1006280i32) {
            None
