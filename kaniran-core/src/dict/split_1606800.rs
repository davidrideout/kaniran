//! Port of `ichiran/dict:split-1606800` (`dict-split.lisp:646`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1606800`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:646`).
//!
...
pub async fn split_1606800(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1606800i32) {
            None
