//! Port of `ichiran/dict:split-de-1679990` (`dict-split.lisp:122`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1679990`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:122`).
//!
...
pub async fn split_de_1679990(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1679990i32) {
            None
