//! Port of `ichiran/dict:split-de-2771850` (`dict-split.lisp:130`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2771850`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:130`).
//!
...
pub async fn split_de_2771850(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2771850i32) {
            None
