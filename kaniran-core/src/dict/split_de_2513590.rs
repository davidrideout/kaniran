//! Port of `ichiran/dict:split-de-2513590` (`dict-split.lisp:129`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2513590`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:129`).
//!
...
pub async fn split_de_2513590(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2513590i32) {
            None
