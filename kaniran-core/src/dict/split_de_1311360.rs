//! Port of `ichiran/dict:split-de-1311360` (`dict-split.lisp:112`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1311360`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:112`).
//!
...
pub async fn split_de_1311360(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1311360i32) {
            None
