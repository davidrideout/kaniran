//! Port of `ichiran/dict:split-2724560` (`dict-split.lisp:399`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2724560`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:399`).
//!
...
pub async fn split_2724560(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2724560i32) {
            None
