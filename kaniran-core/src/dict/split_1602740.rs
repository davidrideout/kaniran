//! Port of `ichiran/dict:split-1602740` (`dict-split.lisp:546`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1602740`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:546`).
//!
...
pub async fn split_1602740(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1602740i32) {
            None
