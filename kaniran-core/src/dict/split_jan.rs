//! Port of `ichiran/dict:split-jan` (`dict-split.lisp:411`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2135280`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:411`).
//!
...
pub async fn split_jan(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2135280i32) {
            None
