//! Port of `ichiran/dict:split-toori-1489800` (`dict-split.lisp:155`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1489800`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:155`).
//!
...
pub async fn split_toori_1489800(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1489800i32) {
            None
