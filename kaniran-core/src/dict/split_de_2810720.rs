//! Port of `ichiran/dict:split-de-2810720` (`dict-split.lisp:105`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2810720`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:105`).
//!
...
pub async fn split_de_2810720(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2810720i32) {
            None
