//! Port of `ichiran/dict:split-1207840` (`dict-split.lisp:650`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1207840`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:650`).
//!
...
pub async fn split_1207840(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "割り", &[1208000i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1207840i32) {
            None
