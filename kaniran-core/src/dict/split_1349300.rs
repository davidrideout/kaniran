//! Port of `ichiran/dict:split-1349300` (`dict-split.lisp:550`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1349300`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:550`).
//!
...
pub async fn split_1349300(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1349300i32) {
            None
