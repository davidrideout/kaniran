//! Port of `ichiran/dict:split-2016840` (`dict-split.lisp:454`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2016840`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:454`).
//!
...
pub async fn split_2016840(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "やった", &[1012980i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2016840i32) {
            None
