//! Port of `ichiran/dict:split-2668400` (`dict-split.lisp:509`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2668400`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:509`).
//!
...
pub async fn split_2668400(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2668400i32) {
            None
