//! Port of `ichiran/dict:split-1774820` (`dict-split.lisp:693`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1774820`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:693`).
//!
...
pub async fn split_1774820(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1774820i32) {
            None
