//! Port of `ichiran/dict:split-shi-2858937` (`dict-split.lisp:219`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2858937`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:219`).
//!
...
pub async fn split_shi_2858937(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2858937i32) {
            None
