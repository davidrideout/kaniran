//! Port of `ichiran/dict:split-de-1479100` (`dict-split.lisp:117`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1479100`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:117`).
//!
...
pub async fn split_de_1479100(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1479100i32) {
            None
