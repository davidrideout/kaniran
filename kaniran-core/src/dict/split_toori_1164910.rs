//! Port of `ichiran/dict:split-toori-1164910` (`dict-split.lisp:167`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1164910`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:167`).
//!
...
pub async fn split_toori_1164910(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1164910i32) {
            None
