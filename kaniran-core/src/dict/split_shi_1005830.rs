//! Port of `ichiran/dict:split-shi-1005830` (`dict-split.lisp:201`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1005830`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:201`).
//!
...
pub async fn split_shi_1005830(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1005830i32) {
            None
