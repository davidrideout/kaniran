//! Port of `ichiran/dict:split-1601080` (`dict-split.lisp:603`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1601080`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:603`).
//!
...
pub async fn split_1601080(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1601080i32) {
            None
