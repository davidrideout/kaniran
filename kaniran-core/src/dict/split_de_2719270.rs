//! Port of `ichiran/dict:split-de-2719270` (`dict-split.lisp:109`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2719270`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:109`).
//!
...
pub async fn split_de_2719270(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2719270i32) {
            None
