//! Port of `ichiran/dict:split-1322560` (`dict-split.lisp:662`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1322560`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:662`).
//!
...
pub async fn split_1322560(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1322560i32) {
            None
