...
pub use get_senses_inner::*;
pub use get_senses_raw_inner::*;
pub use get_senses_str_inner::*;
pub use get_senses_json_inner::*;
pub use match_kana_kanji_inner::*;
pub use match_sense_restrictions_inner::*;
pub use split_pos_inner::*;
pub use short_sense_str_inner::*;
pub use reading_str_inner::*;
pub use reading_str_seq_inner::*;
pub use reading_str_star__inner::*;
pub use entry_info_short_inner::*;
pub use entry_info_long_inner::*;
pub use get_glosses_inner::*;
pub use match_glosses_inner::*;
pub use is_rareru_inner::*;

#[allow(clippy::module_inception, dead_code, unused_imports)]
mod get_senses_inner {
...
#[allow(clippy::module_inception, dead_code, unused_imports)]
mod get_senses_str_inner {
use std::fmt::Write;

use crate::characters::text_utils::join;
use crate::conn::kani_context::KaniranContext;
use crate::dict::senses::get_senses;
...
use super::get_senses;
use crate::dict::kani::KaniWordDispatchEnum;
use super::match_sense_restrictions;
use super::split_pos;
...
#[allow(clippy::module_inception, dead_code, unused_imports)]
mod match_sense_restrictions_inner {
use crate::conn::kani_context::KaniranContext;

use crate::dict::dao::KanaText;
use crate::dict::kani::KaniWordDispatchEnum;
use crate::dict::dao::KanjiText;
use super::{match_kana_kanji, MatchKanaKanjiResult};
use crate::dict::counters::dispatchers::text;
...
#[allow(clippy::module_inception, dead_code, unused_imports)]
mod reading_str_inner {
use crate::dict::best_text::get_kanji;
use super::reading_str_star_;
use crate::dict::word_info::WordInfo;
use crate::dict::best_text::word_info_reading_str;
use crate::conn::kani_context::KaniranContext;
...
#[allow(clippy::module_inception, dead_code, unused_imports)]
mod entry_info_short_inner {
use super::reading_str_seq;
use super::short_sense_str;
use crate::conn::kani_context::KaniranContext;
...
#[allow(clippy::module_inception, dead_code, unused_imports)]
mod entry_info_long_inner {
use std::fmt::Write;

use super::get_senses_str;
use super::reading_str_seq;
use crate::conn::kani_context::KaniranContext;
...
#[allow(clippy::module_inception, dead_code, unused_imports)]
mod match_glosses_inner {
use crate::conn::kani_context::KaniranContext;

use crate::dict::find_word::get_candidates;
use super::get_glosses;
