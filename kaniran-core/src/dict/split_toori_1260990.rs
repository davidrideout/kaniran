//! Port of `ichiran/dict:split-toori-1260990` (`dict-split.lisp:146`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1260990`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:146`).
//!
...
pub async fn split_toori_1260990(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1260990i32) {
            None
