//! Port of `ichiran/dict:split-shi-2518250` (`dict-split.lisp:216`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2518250`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:216`).
//!
...
pub async fn split_shi_2518250(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2518250i32) {
            None
