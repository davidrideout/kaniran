//! Port of `ichiran/dict:split-souda` (`dict-split.lisp:263`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1006650`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:263`).
//!
...
pub async fn split_souda(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1006650i32) {
            None
