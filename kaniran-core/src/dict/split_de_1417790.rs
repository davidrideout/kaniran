//! Port of `ichiran/dict:split-de-1417790` (`dict-split.lisp:115`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1417790`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:115`).
//!
...
pub async fn split_de_1417790(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1417790i32) {
            None
