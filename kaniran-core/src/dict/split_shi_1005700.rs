//! Port of `ichiran/dict:split-shi-1005700` (`dict-split.lisp:200`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1005700`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:200`).
//!
...
pub async fn split_shi_1005700(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1005700i32) {
            None
