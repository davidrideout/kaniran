//! Port of `ichiran/dict:split-1474200` (`dict-split.lisp:495`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1474200`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:495`).
//!
...
pub async fn split_1474200(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1474200i32) {
            None
