//! Port of `ichiran/dict:split-de-1395670` (`dict-split.lisp:114`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1395670`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:114`).
//!
...
pub async fn split_de_1395670(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1395670i32) {
            None
