//! Port of `ichiran/dict:split-2083990` (`dict-split.lisp:424`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2083990`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:424`).
//!
...
pub async fn split_2083990(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2083990i32) {
            None
