//! Port of the dict-grammar.lisp suffix-rule layer.

pub use def_simple_suffix_macro_inner::*;
pub use suffix_tai_inner::*;
pub use suffix_ren_inner::*;
pub use suffix_ren__inner::*;
pub use suffix_neg_inner::*;
pub use te_check_inner::*;
pub use suffix_te_inner::*;
pub use teiru_check_inner::*;
pub use suffix_teiru_inner::*;
pub use suffix_teiru_plus__inner::*;
pub use suffix_te_plus_space_inner::*;
pub use suffix_kudasai_inner::*;
pub use suffix_te_ren_inner::*;
pub use suffix_teii_inner::*;
pub use suffix_chau_inner::*;
pub use suffix_to_inner::*;
pub use suffix_suru_inner::*;
pub use apply_patch_inner::*;
pub use suffix_sou_base_macro_inner::*;
pub use suffix_sou_inner::*;
pub use suffix_sou_plus__inner::*;
pub use suffix_rou_inner::*;
pub use suffix_adv_inner::*;
pub use suffix_sugiru_inner::*;
pub use suffix_sa_inner::*;
pub use suffix_iadj_inner::*;
pub use suffix_garu_inner::*;
pub use suffix_ra_inner::*;
pub use suffix_rashii_inner::*;
pub use suffix_desu_inner::*;
pub use suffix_desho_inner::*;
pub use suffix_tosuru_inner::*;
pub use suffix_kurai_inner::*;
pub use parse_suffix_val_inner::*;

#[allow(clippy::module_inception, dead_code, unused_imports)]
mod def_simple_suffix_macro_inner {
...
#[allow(clippy::module_inception, dead_code, unused_imports)]
mod suffix_sou_base_macro_inner {
use crate::conn::kani_context::KaniranContext;
use crate::dict::grammar::suffix_rules::apply_patch;
use crate::dict::grammar::suffix_rules::PrimaryWord;
...
mod tests {
    ...
    /// [`crate::dict::grammar::suffix_init::SUFFIX_LIST`] so that
    /// [`crate::dict::grammar::find_word::find_word_with_suffix`]'s inner
