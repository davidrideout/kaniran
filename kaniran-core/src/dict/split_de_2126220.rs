//! Port of `ichiran/dict:split-de-2126220` (`dict-split.lisp:127`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2126220`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:127`).
//!
...
pub async fn split_de_2126220(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2126220i32) {
            None
