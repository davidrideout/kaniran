//! Port of `ichiran/dict:split-de-1510140` (`dict-split.lisp:118`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1510140`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:118`).
//!
...
pub async fn split_de_1510140(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1510140i32) {
            None
