//! Port of `ichiran/dict:split-2026650` (`dict-split.lisp:542`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2026650`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:542`).
//!
...
pub async fn split_2026650(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2026650i32) {
            None
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "せよ", &[1157170i32]).await?;
