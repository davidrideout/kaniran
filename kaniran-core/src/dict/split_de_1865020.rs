//! Port of `ichiran/dict:split-de-1865020` (`dict-split.lisp:125`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1865020`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:125`).
//!
...
pub async fn split_de_1865020(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1865020i32) {
            None
