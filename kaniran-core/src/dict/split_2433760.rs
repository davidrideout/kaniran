//! Port of `ichiran/dict:split-2433760` (`dict-split.lisp:391`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2433760`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:391`).
//!
...
pub async fn split_2433760(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2433760i32) {
            None
