//! Port of `ichiran/dict:split-do-2523480` (`dict-split.lisp:183`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2523480`.
//! Generated upstream by `def-do-split` (`dict-split.lisp:183`).
//!
...
pub async fn split_do_2523480(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2523480i32) {
            None
