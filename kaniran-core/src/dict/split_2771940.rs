//! Port of `ichiran/dict:split-2771940` (`dict-split.lisp:415`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2771940`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:415`).
//!
...
pub async fn split_2771940(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2771940i32) {
            None
