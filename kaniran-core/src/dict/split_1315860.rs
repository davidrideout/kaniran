//! Port of `ichiran/dict:split-1315860` (`dict-split.lisp:491`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1315860`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:491`).
//!
...
pub async fn split_1315860(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1315860i32) {
            None
