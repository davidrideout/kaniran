//! Port of `ichiran/dict:split-2088480` (`dict-split.lisp:395`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2088480`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:395`).
//!
...
pub async fn split_2088480(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2088480i32) {
            None
