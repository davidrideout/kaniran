//! Port of `ichiran/dict:split-do-2142710` (`dict-split.lisp:177`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2142710`.
//! Generated upstream by `def-do-split` (`dict-split.lisp:177`).
//!
...
pub async fn split_do_2142710(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2142710i32) {
            None
