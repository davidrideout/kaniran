//! Port of `ichiran/dict:split-shi-1305110` (`dict-split.lisp:209`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1305110`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:209`).
//!
...
pub async fn split_shi_1305110(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1305110i32) {
            None
