//! Port of `ichiran/dict:split-de-1272220` (`dict-split.lisp:111`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1272220`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:111`).
//!
...
pub async fn split_de_1272220(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1272220i32) {
            None
