//! Port of `ichiran/dict:split-1591050` (`dict-split.lisp:514`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1591050`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:514`).
//!
...
pub async fn split_1591050(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1591050i32) {
            None
