//! Port of `ichiran/dict:split-de-1518550` (`dict-split.lisp:119`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1518550`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:119`).
//!
...
pub async fn split_de_1518550(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1518550i32) {
            None
