//! Port of `ichiran/dict:split-1591980` (`dict-split.lisp:569`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1591980`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:569`).
//!
...
pub async fn split_1591980(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1591980i32) {
            None
