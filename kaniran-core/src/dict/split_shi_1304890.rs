//! Port of `ichiran/dict:split-shi-1304890` (`dict-split.lisp:207`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1304890`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:207`).
//!
...
pub async fn split_shi_1304890(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1304890i32) {
            None
