//! Port of `ichiran/dict:split-toiu` (`dict-split.lisp:364`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1922760`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:364`).
//!
...
pub async fn split_toiu(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1922760i32) {
            None
