//! Port of `ichiran/dict:split-1881690` (`dict-split.lisp:675`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1881690`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:675`).
//!
...
pub async fn split_1881690(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1881690i32) {
            None
