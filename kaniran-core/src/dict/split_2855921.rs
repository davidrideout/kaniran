//! Port of `ichiran/dict:split-2855921` (`dict-split.lisp:688`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2855921`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:688`).
//!
