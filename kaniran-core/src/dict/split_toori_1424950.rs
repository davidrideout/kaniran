//! Port of `ichiran/dict:split-toori-1424950` (`dict-split.lisp:150`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1424950`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:150`).
//!
...
pub async fn split_toori_1424950(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1424950i32) {
            None
