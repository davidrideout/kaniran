//! Port of `ichiran/dict:split-1597740` (`dict-split.lisp:591`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1597740`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:591`).
//!
...
pub async fn split_1597740(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1597740i32) {
            None
