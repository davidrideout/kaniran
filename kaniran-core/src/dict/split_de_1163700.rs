//! Port of `ichiran/dict:split-de-1163700` (`dict-split.lisp:102`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1163700`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:102`).
//!
...
pub async fn split_de_1163700(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1163700i32) {
            None
