//! Port of `ichiran/dict:split-1322540` (`dict-split.lisp:468`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1322540`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:468`).
//!
...
pub async fn split_1322540(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1322540i32) {
            None
