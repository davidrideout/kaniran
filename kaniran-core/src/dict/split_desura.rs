//! Port of `ichiran/dict:split-desura` (`dict-split.lisp:348`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2034520`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:348`).
//!
...
pub async fn split_desura(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2034520i32) {
            None
