...
use crate::dict::counters::methods::common as common_fn;
...
use crate::dict::counters::methods::nokanji;
use crate::dict::counters::methods::ord as ord_fn;
...
use crate::dict::counters::methods::text as text_fn;
