//! Port of `ichiran/dict:split-1579130` (`dict-split.lisp:504`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1579130`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:504`).
//!
...
pub async fn split_1579130(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1579130i32) {
            None
