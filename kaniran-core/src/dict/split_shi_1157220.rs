//! Port of `ichiran/dict:split-shi-1157220` (`dict-split.lisp:203`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1157220`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:203`).
//!
...
pub async fn split_shi_1157220(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1157220i32) {
            None
