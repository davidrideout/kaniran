//! Port of `ichiran/dict:split-1314600` (`dict-split.lisp:464`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1314600`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:464`).
//!
...
pub async fn split_1314600(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1314600i32) {
            None
