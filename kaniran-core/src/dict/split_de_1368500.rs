//! Port of `ichiran/dict:split-de-1368500` (`dict-split.lisp:113`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1368500`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:113`).
//!
...
pub async fn split_de_1368500(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1368500i32) {
            None
