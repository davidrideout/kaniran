//! Port of `ichiran/dict:split-osoreiru` (`dict-split.lisp:297`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1236680`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:297`).
//!
...
pub async fn split_osoreiru(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1236680i32) {
            None
