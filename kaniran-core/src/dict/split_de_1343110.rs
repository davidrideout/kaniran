//! Port of `ichiran/dict:split-de-1343110` (`dict-split.lisp:132`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1343110`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:132`).
//!
...
pub async fn split_de_1343110(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1343110i32) {
            None
