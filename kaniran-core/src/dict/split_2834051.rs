//! Port of `ichiran/dict:split-2834051` (`dict-split.lisp:640`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2834051`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:640`).
//!
...
pub async fn split_2834051(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2834051i32) {
            None
