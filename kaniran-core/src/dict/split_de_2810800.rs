//! Port of `ichiran/dict:split-de-2810800` (`dict-split.lisp:131`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2810800`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:131`).
//!
...
pub async fn split_de_2810800(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2810800i32) {
            None
