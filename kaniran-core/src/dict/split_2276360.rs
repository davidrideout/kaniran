//! Port of `ichiran/dict:split-2276360` (`dict-split.lisp:500`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2276360`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:500`).
//!
...
pub async fn split_2276360(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2276360i32) {
            None
