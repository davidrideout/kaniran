//! Port of `ichiran/dict:split-1362970` (`dict-split.lisp:698`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1362970`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:698`).
//!
...
pub async fn split_1362970(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "申し", &[1363090i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1362970i32) {
            None
