//! Port of `ichiran/dict:split-shi-1157240` (`dict-split.lisp:217`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1157240`.
//! Generated upstream by `def-shi-split` (`dict-split.lisp:217`).
//!
...
pub async fn split_shi_1157240(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1157240i32) {
            None
