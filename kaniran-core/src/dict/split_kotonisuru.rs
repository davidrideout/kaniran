//! Port of `ichiran/dict:split-kotonisuru` (`dict-split.lisp:335`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2215340`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:335`).
//!
...
pub async fn split_kotonisuru(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2215340i32) {
            None
