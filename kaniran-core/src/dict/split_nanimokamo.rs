//! Port of `ichiran/dict:split-nanimokamo` (`dict-split.lisp:281`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1599590`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:281`).
//!
...
pub async fn split_nanimokamo(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1599590i32) {
            None
