//! Port of `ichiran/dict:split-de-1245390` (`dict-split.lisp:108`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1245390`.
//! Generated upstream by `def-de-split` (`dict-split.lisp:108`).
//!
...
pub async fn split_de_1245390(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1245390i32) {
            None
