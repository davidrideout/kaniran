//! Port of `ichiran/dict:split-1606530` (`dict-split.lisp:619`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1606530`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:619`).
//!
...
pub async fn split_1606530(
    ...
    {
        let pseq_lookup = find_word_conj_of(ctx, "分かり", &[1606560i32]).await?;
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1606530i32) {
            None
