//! Port of `ichiran/dict:split-1508380` (`dict-split.lisp:432`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1508380`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:432`).
//!
...
pub async fn split_1508380(
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1508380i32) {
            None
