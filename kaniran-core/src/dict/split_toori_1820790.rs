//! Port of `ichiran/dict:split-toori-1820790` (`dict-split.lisp:153`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `1820790`.
//! Generated upstream by `def-toori-split` (`dict-split.lisp:153`).
//!
...
pub async fn split_toori_1820790(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&1820790i32) {
            None
