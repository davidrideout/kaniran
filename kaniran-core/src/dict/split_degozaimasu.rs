//! Port of `ichiran/dict:split-degozaimasu` (`dict-split.lisp:135`).
//!
//! Registered in [`crate::dict::_star_split_map_star_`] for seq `2253080`.
//! Generated upstream by `def-simple-split` (`dict-split.lisp:135`).
//!
...
pub async fn split_degozaimasu(
    ctx: &KaniranContext,
...

    {
        ...
        let pushed: Option<SplitPart> = if pseq.contains(&2253080i32) {
            None
